public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        // Начальная дата
        String startingData = "01.02.1999";
        ...
        // Путь до файла
        String filePath = "C:\\Program files\\cmder_mini\\Cmder.exe";
        ...
        // Соединение активное?
        boolean isAvtiveConnection = true;
        System.out.println("Соединение активное? = " + isAvtiveConnection);
